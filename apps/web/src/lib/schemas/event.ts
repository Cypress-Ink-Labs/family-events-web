...
export const eventRowSchema = z.object({
  ...
  age_min: z.coerce.number().nullable(),
  age_max: z.coerce.number().nullable(),
  ...
  ai_confidence: z.coerce.number().nullable(),
  ai_tag_provider: z.enum(["openai", "ollama", "localai"]).nullable(),
  ai_tag_model: z
    .string()
    .nullable()
    .optional()
